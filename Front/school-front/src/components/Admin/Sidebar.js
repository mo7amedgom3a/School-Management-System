...
import { LogOutIcon, SchoolIcon, UsersIcon, PencilIcon, SettingsIcon } from "../Teacher/icons"; 

export default function Sidebar({ setActiveComponent }) {  // Accept setActiveComponent as a prop
  return (
